		...
		<div class="card text-center">
		  	<div class="card-header">
			    <ul class="nav nav-tabs card-header-tabs">
			      ...
			      <li class="nav-item">
			        <a class="nav-link active" id="seactive"><button type="button" class="btn btn-outline-info" id="search">Search</button></a>
			      </li>
			      <li class="nav-item">
			...
			<div class="card-body">
				<div id="content">
					...
					<h3>Select the file to Search</h3>	
					<?php
						while($num--){
					...
					<div class="text-center">	
						<input class="form-control-sm col-4" type="text" placeholder="Text to Search" name="searchstring">
						<button name='search' class='btn btn-success' id='seasuccess'>Search</button>
					</div>
					<div class="ans">
						<?php
