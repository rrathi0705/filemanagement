<?php 
	...
	if(isset($_POST['edit'])){
		...
		header("location: edit.php?EditSuccessful");
	}
?>
		...
		<div class="card text-center">
		  	<div class="card-header">
			    <ul class="nav nav-tabs card-header-tabs">
			      ...
			      <li class="nav-item">
			        <a class="nav-link active" id="edactive"><button type="button" class="btn btn-outline-primary" id="edit">Edit</button></a>
			      </li>
			      <li class="nav-item">
			...
			<div class="card-body">
				<div id="content">
					...
					<div class="text-center">	
						<input class="form-control-sm col-4" type="text" placeholder="Old Text" name="oldstring">
						<input class="form-control-sm col-4" type="text" placeholder="New Text" name="newstring">
						<button name='edit' class='btn btn-success' id='edsuccess'>Edit</button>
					</div>
					<div class="ans">
					</div>
					</form>
